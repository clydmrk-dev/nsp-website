...
# Marquee: use two identical sequences with normal spacing at every phrase boundary.
...
# Keep the standard 50px gap after every marquee phrase, including the loop boundary.
s = s.replace('.marquee span:nth-child(8n){margin-right:0;}\n', '')
...
old_products = "const products={1:{name:'NSP Collection 01',price:490,image:'/1.png'},2:{name:'NSP Collection 02',price:490,image:'/2.png'},3:{name:'NSP Collection 03',price:490,image:'/3.png'},4:{name:'NSP Collection 02',price:490,image:'/4.png'},5:{name:'NSP Collection 05',price:490,image:'/5.png'},6:{name:'NSP Collection 02',price:490,image:'/6.png'},7:{name:'NSP Collection 07',price:490,image:'/7.png'}};"
